...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_18__["Location"], { provide: _angular_common__WEBPACK_IMPORTED_MODULE_18__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_18__["HashLocationStrategy"] }
            ],
...
var AboutusComponent = /** @class */ (function () {
    ...
    AboutusComponent.prototype.clearcolor = function () {
...
var CollectionsComponent = /** @class */ (function () {
    ...
    CollectionsComponent.prototype.clearcolor = function () {
        document.getElementById("navlink1").style.color = "#000";
        document.getElementById("navlink2").style.color = "#000";
        document.getElementById("navlink3").style.color = "#000";
        document.getElementById("navlink4").style.color = "#000";
...
var ContactusComponent = /** @class */ (function () {
    ...
    ContactusComponent.prototype.clearcolor = function () {
        document.getElementById("navlink1").style.color = "#000";
        document.getElementById("navlink2").style.color = "#000";
        document.getElementById("navlink3").style.color = "#000";
        document.getElementById("navlink4").style.color = "#000";
...
var GoldSchemesComponent = /** @class */ (function () {
    ...
    GoldSchemesComponent.prototype.clearcolor = function () {
        document.getElementById("navlink1").style.color = "#000";
        document.getElementById("navlink2").style.color = "#000";
        document.getElementById("navlink3").style.color = "#000";
        document.getElementById("navlink4").style.color = "#000";
...
module.exports = "#language {\n  background: transparent;\n  border: 0;\n  color: black; }\n\n.langclass {\n  width: 5em;\n  color: #272727;\n  border: 0; }\n\n#language:focus {\n  outline: 0; }\n\n#changedropicon {\n  width: 16px;\n  padding-top: 12px;\n  margin-left: -17px; }\n\n.dropdown-menu:after {\n  content: \"\";\n  position: absolute;\n  right: 4px;\n  top: -22px;\n  width: 0;\n  height: 0;\n  border-style: solid;\n  border-width: 0 17px 17px 17px;\n  border-color: transparent transparent #ffffff transparent;\n  z-index: 9998; }\n\n#language option {\n  background-color: transparent;\n  border: 5px solid #fff;\n  border-radius: 5em;\n  color: grey; }\n\n#navdropdown1 {\n  position: absolute;\n  margin-left: 19%;\n  margin-top: 15px;\n  border: 0px;\n  font-size: 16px;\n  line-height: 2.4;\n  width: 300px;\n  font-family: 'opR','tamilf'; }\n\n#navdropdown2 {\n  position: absolute;\n  margin-left: 31.5%;\n  margin-top: 15px;\n  border: 0px;\n  font-size: 16px;\n  line-height: 2.4;\n  width: 300px;\n  font-family: 'opR','tamilf'; }\n\n.submenu {\n  transition: 0.5s all ease-in-out;\n  position: absolute;\n  background-color: #fff;\n  right: -21.5rem;\n  margin-top: -4rem;\n  cursor: pointer;\n  padding: 0;\n  display: none; }\n\n.dropdown-item:hover {\n  color: #CC9F08;\n  cursor: pointer; }\n\n.downarrowmenu {\n  opacity: 0;\n  margin-left: 0px;\n  transition: 0.5s all ease-in-out;\n  float: right;\n  transform: rotate(-90deg);\n  margin-right: 0rem;\n  margin-top: 1.2rem; }\n\n.dropdown-item:hover > span > .downarrowmenu {\n  opacity: 1;\n  margin-left: 8px;\n  transition: 0.5s all ease-in-out;\n  float: right;\n  transform: rotate(-90deg);\n  margin-right: 0rem;\n  margin-top: 1.2rem; }\n\n.dropdown-item:hover {\n  color: #CC9F08;\n  cursor: pointer; }\n\n.navbar {\n  position: relative;\n  display: flex;\n  flex-wrap: wrap;\n  box-shadow: 0 0 10px 0 #e2e2e2;\n  overflow-y: unset;\n  margin: 0;\n  background-color: #fff;\n  align-items: center;\n  justify-content: left;\n  padding: 0.5rem 1rem 0px 1rem;\n  border: 0;\n  transition: 0.5s all ease-in-out; }\n\n#navbarContent {\n  position: relative; }\n\n.navbar-brand {\n  margin: 0 !important;\n  padding: 0 0px 0 50px;\n  height: auto;\n  font-size: 18px; }\n\n.collapser {\n  position: absolute;\n  right: 1em;\n  top: 2.2em; }\n\n.navbar-light .navbar-toggler {\n  border-width: 0px;\n  outline-width: 0px; }\n\n.navbar-light .navbar-nav .nav-link:hover, .navbar-light .navbar-nav .nav-link:focus {\n  color: #CC9F08;\n  /* margin-top: 2px; */\n  margin: 0;\n  width: 100%; }\n\n.navbar-light .navbar-nav .nav-link {\n  color: #000;\n  font-size: 18px;\n  font-family: 'opB','tamilf';\n  padding: 25px 1rem;\n  text-align: right; }\n\n.nav-link:hover {\n  cursor: pointer; }\n\n.logoimg {\n  height: 75px; }\n\n.logoimg:hover {\n  cursor: pointer; }\n\nul {\n  width: 70%;\n  margin: auto; }\n\n.navbar-nav > li {\n  padding: 0 30px; }\n\n.phoneiconheader {\n  padding-right: 1rem;\n  filter: brightness(0%) contrast(50%); }\n\n.navbar-nav {\n  margin: 5px 0% 0 13%;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  overflow-x: auto; }\n\n.lang {\n  display: flex;\n  flex-direction: row;\n  font-size: 12px;\n  padding-top: 5px; }\n\n.langclass {\n  width: 6rem;\n  margin: 0 0 0 1rem; }\n\n.phonelink {\n  padding-top: 1.3rem; }\n\n::ng-deep .mat-option-text {\n  color: #444; }\n\n::ng-deep .mat-form-field-underline {\n  display: none; }\n\n::ng-deep .mat-select-arrow {\n  color: #444 !important;\n  border-left: 15px solid transparent !important;\n  border-right: none !important;\n  border-top: 15px solid transparent !important;\n  border-image-source: none !important;\n  border-image-repeat: stretch !important;\n  margin-top: -2px !important;\n  transform: scale(0.7); }\n\n::ng-deep .mat-option-text {\n  color: #444; }\n\n.radbutton {\n  display: block;\n  font-family: 'opR','tamilf';\n  font-size: 12px;\n  line-height: 3rem;\n  color: #444; }\n\nbutton:focus {\n  outline: 0; }\n\n.radbutton:hover {\n  color: #CC9F08; }\n\n::ng-deep .mat-radio-label-content {\n  line-height: 3rem; }\n\n::ng-deep .mat-menu-content {\n  padding: 1em 0 1em 1em; }\n\n::ng-deep .mat-radio-label-content {\n  line-height: 3rem; }\n\n@media screen and (max-width: 2700px) {\n  .navbar-nav {\n    margin: 5px 0% 0 35%; }\n  #navdropdown1 {\n    margin-left: 37%; }\n  #navdropdown2 {\n    margin-left: 43.5%; } }\n\n@media screen and (max-width: 1600px) {\n  .navbar-nav {\n    margin: 0px 0% 0 15%;\n    height: 100%;\n    margin-left: 15%; }\n  #navdropdown1 {\n    margin-left: 24%; }\n  #navdropdown2 {\n    margin-left: 36%; } }\n\n@media screen and (max-width: 1500px) {\n  .navbar-nav {\n    margin: -5px 0% 0 9%;\n    height: 100%;\n    margin-left: 15%; } }\n\n@media screen and (max-width: 1330px) {\n  .navbar-nav {\n    padding: 0 6px; }\n  .navbar-nav > li {\n    padding: 0px 10px; }\n  .navbar-light .navbar-nav .nav-link {\n    font-size: 16px; }\n  #navdropdown1 {\n    margin-left: 15%; }\n  #navdropdown2 {\n    margin-left: 28%; } }\n\n@media screen and (max-width: 1030px) {\n  .navbar-nav {\n    margin: 5px 0% 0 13%; }\n  .navbar-nav > li {\n    padding: 0 13px; }\n  .navbar-light .navbar-nav .nav-link {\n    padding: 25px 1rem;\n    font-size: 14px; }\n  #navdropdown1 {\n    margin-left: 15%; }\n  #navdropdown2 {\n    margin-left: 28%; }\n  .lang {\n    padding-top: 4px; } }\n\n::ng-deep .mat-select-value {\n  color: rgba(0, 0, 0, 0.87); }\n\n@media screen and (max-width: 768px) {\n  .topnav > .lang > #language {\n    position: absolute;\n    top: 2.5em;\n    z-index: 17;\n    right: 5em; }\n  .logoimg {\n    height: 60px; }\n  .navbar-nav > li {\n    padding: 0 0rem; }\n  .navbar-nav {\n    margin-left: 6rem; }\n  .navbar {\n    padding: 0.5rem 1rem 1rem 1rem; }\n  .navbar-brand {\n    padding-left: 20px; }\n  .phonelink {\n    display: none; }\n  .lang {\n    position: absolute;\n    right: 1rem;\n    top: 1rem; }\n  .navbar-light .navbar-nav .nav-link {\n    padding: 25px 1rem;\n    font-size: 14px; } }\n\n@media screen and (max-width: 500px) {\n  .lang {\n    right: 5rem;\n    top: 1.5rem; }\n  .downarrowmenu {\n    display: none; }\n  .navbar-nav {\n    margin-left: 1rem; }\n  #navdropdown1 {\n    margin-bottom: 1rem;\n    box-shadow: none;\n    margin-left: 0;\n    width: 100%;\n    position: unset;\n    background-color: #fff;\n    border: 0px;\n    font-size: 16px;\n    line-height: 2.4;\n    -ms-overflow-style: none;\n    /* IE and Edge */\n    scrollbar-width: none; }\n  #navdropdown2 {\n    margin-bottom: 1rem;\n    box-shadow: none;\n    margin-left: 0;\n    width: 100%;\n    position: unset;\n    background-color: #fff;\n    border: 0px;\n    font-size: 16px;\n    line-height: 2.4;\n    -ms-overflow-style: none;\n    /* IE and Edge */\n    scrollbar-width: none; }\n  .downarrowmenu {\n    transform: rotate(0deg);\n    opacity: 1; }\n  .dropdown-item:hover > span > .downarrowmenu {\n    transform: rotate(0deg); }\n  .nav-link {\n    font-family: 'opEB','tamilf';\n    color: #CC9F08; }\n  .dropdown-menu > a {\n    font-family: 'opR','tamilf';\n    color: #CC9F08; }\n  .navbar > div > ul > li > a {\n    font-size: 18px;\n    text-align: left; }\n  .submenu {\n    transition: 0.5s all ease-in-out;\n    position: unset;\n    cursor: pointer;\n    padding: 0;\n    width: 100%;\n    font-weight: 100;\n    margin-top: 0rem;\n    padding: 0 2rem;\n    background-color: #ffffff;\n    border: 1px solid #fff; }\n  .submenu > a {\n    font-family: 'opR','tamilf'; }\n  .downarrowmenu {\n    transform: rotate(0deg);\n    opacity: 1;\n    display: block; }\n  .dropdown-item:hover > span > .downarrowmenu {\n    transform: rotate(0deg); } }\n\n.dropdown-submenu {\n  position: relative; }\n\n.dropdown-submenu .dropdown-menu {\n  top: 0;\n  left: 100%;\n  margin-top: -1px;\n  display: block;\n  width: 100%;\n  margin: 10px 0;\n  color: #fff;\n  background-color: #efefef;\n  font-size: 14px;\n  border: 0; }\n\n.dropdown-toggle::after {\n  display: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(ts, sh, router) {
        ...
        this.sh = sh;
        this.router = router;
        this.langlist1 = [{ key: 'LA-EN', value: 'English', checked: false }, { key: 'LA-TA', value: 'தமிழ்', checked: false }];
    }
    ...
    HeaderComponent.prototype.goToPage = function (route, num) {
        this.router.navigate([route]);
    };
...
module.exports = "@import url(\"https://cdn.materialdesignicons.com/5.4.55/css/materialdesignicons.min.css\");\nmat-sidenav-container, mat-sidenav-content, mat-sidenav {\n  height: 100%; }\nmat-sidenav {\n  width: 250px; }\n.cartext {\n  position: absolute;\n  top: 40vh;\n  left: -70rem;\n  font-family: dance;\n  text-align: center;\n  font-size: 4rem;\n  height: 5rem; }\nmain {\n  padding: 10px; }\n.wrapper {\n  overflow-x: hidden;\n  position: relative; }\n.herocarosol {\n  position: relative;\n  height: 100vh; }\n.heroc {\n  height: 100vh; }\n.carousel-inner {\n  height: 100%; }\n.carousel-item, .item, .carousel-item.active {\n  height: 100%;\n  text-align: center;\n  position: relative; }\n.textonimg {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%); }\n#changedrop {\n  width: 12px;\n  padding-top: 6px; }\n.downarrow {\n  color: white;\n  /* position: absolute; */\n  font-size: 5em;\n  /* margin-top: -9rem; */\n  /* bottom: 20rem; */\n  /* left: 47%; */\n  -webkit-animation: mymove 1s infinite;\n  animation: mymove 1s infinite;\n  cursor: pointer; }\n.downarrowdiv {\n  text-align: center;\n  margin-top: -6rem; }\n@-webkit-keyframes mymove {\n  from {\n    opacity: 0;\n    bottom: 0.5em; }\n  to {\n    opacity: 1;\n    bottom: 0; } }\n@keyframes mymove {\n  from {\n    opacity: 0;\n    bottom: 0.5em; }\n  to {\n    opacity: 1;\n    bottom: 0; } }\n.todaysrate {\n  position: fixed;\n  display: inline-flex;\n  top: 70%;\n  right: 0;\n  text-align: right;\n  z-index: 5;\n  cursor: pointer; }\n#products {\n  margin-left: 10em; }\n.dropdown {\n  float: left;\n  overflow: hidden; }\n.dropdown .dropbtn {\n  font-size: 17px;\n  border: none;\n  outline: none;\n  color: white;\n  padding: 14px 16px;\n  background-color: inherit;\n  font-family: inherit;\n  margin: 0; }\n.dropdown-content {\n  display: none;\n  position: absolute;\n  background-color: #f9f9f9;\n  min-width: 160px;\n  box-shadow: 0px 8px 16px 0px rgba(0, 0, 0, 0.2);\n  z-index: 1; }\n.lang {\n  float: right; }\n.dropdown-content a {\n  float: none;\n  color: black;\n  padding: 12px 16px;\n  text-decoration: none;\n  display: block;\n  text-align: left; }\n.rarrow {\n  transform: rotate(-90deg);\n  width: 14px;\n  margin-left: -8px;\n  margin-top: -2px;\n  opacity: 0;\n  transition: 0.5s all ease-in-out; }\n.dropdown-content a:hover {\n  background-color: #ddd;\n  color: black; }\n.dropdown:hover .dropdown-content {\n  display: block; }\n#language {\n  background: transparent;\n  border: 0;\n  color: white; }\n#language:focus {\n  outline: 0; }\n#language option {\n  background-color: transparent;\n  border: 5px solid #fff;\n  border-radius: 5em;\n  color: grey; }\n.carosolimg {\n  transition: 0.3s all ease-in-out;\n  height: 100%;\n  -o-object-fit: cover;\n     object-fit: cover; }\n.bodyView {\n  padding: 0em 6em;\n  width: 100%; }\n.bodyHeading {\n  padding: 0 0.5em;\n  font-size: 26px;\n  margin: 80px 0 32px 0;\n  border-left: 8px solid #CC9F08; }\n.bold {\n  font-family: 'opEB','tamilf'; }\n.imageContainer {\n  position: relative;\n  overflow: hidden;\n  margin: 0em 2em 0em 0em;\n  color: #fff;\n  border-radius: 5px; }\n.phonelink {\n  font-size: 12px;\n  padding-top: 1em; }\n#prevuser {\n  opacity: 0; }\n#prevuser:hover {\n  cursor: pointer; }\n#nextuser {\n  opacity: 0; }\n#nextuser:hover {\n  cursor: pointer; }\n#user1 {\n  display: block;\n  transition: 0.5s all ease-in-out; }\n#user2 {\n  display: block;\n  transition: 0.5s all ease-in-out; }\n.marbar2 {\n  margin-bottom: 2em; }\n.collectionGoldImage {\n  width: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  height: 530px;\n  border-radius: 5px;\n  transition: all 0.3s cubic-bezier(0.165, 0.84, 0.44, 1); }\n.silver {\n  width: 102%; }\n.collectionwedding {\n  width: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  height: 530px;\n  border-radius: 5px;\n  transition: all 0.3s cubic-bezier(0.165, 0.84, 0.44, 1); }\n.smallheight {\n  height: 510px; }\n.collectionImage {\n  width: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  height: 250px;\n  border-radius: 5px;\n  transition: all 0.3s cubic-bezier(0.165, 0.84, 0.44, 1); }\n.weddingcoll {\n  padding: 0; }\n.bottom-left {\n  position: absolute;\n  bottom: 1em;\n  color: #fff;\n  left: 2em;\n  font-family: 'opB','tamilf';\n  font-size: 2em; }\n.collectionImage:hover, .collectionGoldImage:hover, .collectionwedding:hover {\n  cursor: pointer; }\n.p25 {\n  padding-right: 25px; }\n.collectionImage:hover + .bottom-left > .rarrow, .collectionGoldImage:hover + .bottom-left > .rarrow, .collectionwedding:hover + .bottom-left > .rarrow {\n  opacity: 1;\n  margin-left: 8px;\n  transition: 0.5s all ease-in-out; }\n.PromiseContainer {\n  height: 144px;\n  text-align: center;\n  width: 100%;\n  padding: 3em 4em;\n  border-radius: 5px;\n  position: relative; }\n.pcolor1 {\n  background-color: #FFFBEF; }\n.pcolor2 {\n  background-color: #FFF7E3; }\n.promiseBody {\n  font-family: 'opB','tamilf';\n  font-size: 18px; }\n.numbering {\n  position: absolute;\n  top: -1em;\n  left: 2em;\n  width: 24px;\n  height: 24px;\n  background-color: #333333;\n  color: #fff;\n  font-size: 16px;\n  font-family: 'opEB','tamilf';\n  border-radius: 5px; }\n::ng-deep .mat-option-text {\n  color: #444; }\n.radbutton {\n  display: block;\n  font-family: 'opR','tamilf';\n  font-size: 12px;\n  line-height: 3rem;\n  color: #444; }\n.radbutton:hover {\n  color: #CC9F08; }\n::ng-deep .mat-radio-label-content {\n  line-height: 3rem; }\n::ng-deep .mat-menu-content {\n  padding: 1em 0 1em 1em; }\n::ng-deep .mat-option-text:hover {\n  color: #CC9F08;\n  font-weight: 600; }\n::ng-deep .mat-select-arrow {\n  color: #fff;\n  border-left: 15px solid transparent !important;\n  border-right: none !important;\n  border-top: 15px solid transparent !important;\n  border-image-source: none !important;\n  border-image-repeat: stretch !important;\n  margin-top: -2px !important; }\n.marginTop {\n  margin-top: 8em; }\n.userpic {\n  display: inline-flex;\n  height: 100px;\n  position: relative; }\n.userimg {\n  width: 100px;\n  border-radius: 6px;\n  -o-object-fit: cover;\n     object-fit: cover; }\n.doublequotes {\n  width: 30px;\n  height: 30px;\n  margin: 1em 0; }\nbutton:focus {\n  outline: 0; }\n.username {\n  margin: auto;\n  padding: 0 2em; }\n.name {\n  color: #444444;\n  font-size: 18px; }\n.designation {\n  color: #999999;\n  font-size: 14px; }\n.comments {\n  font-size: 16px;\n  color: #777777; }\n.usercomment {\n  margin: 3em 0; }\n.dropdown-toggle::after {\n  display: none; }\n.talktous {\n  background-color: #F6F7F7;\n  color: #666666;\n  height: 146px;\n  margin: auto;\n  padding: 2em 1em;\n  font-size: 20px; }\n.talktousButton {\n  background-color: #CC9F08;\n  color: #fff;\n  border-radius: 5px;\n  margin: 1em;\n  float: right;\n  border: 0;\n  padding: 4px 16px; }\n.rel {\n  position: relative;\n  height: 100%;\n  weight: 100%; }\n.h500 {\n  height: 500px;\n  width: 100%; }\n.w100 {\n  width: 100%;\n  -o-object-fit: cover;\n     object-fit: cover; }\n.mar-3 {\n  margin-bottom: 20px; }\n.mar-r-1 {\n  margin-right: 1em; }\n.h240 {\n  height: 240px; }\n.logoimg {\n  height: 75px; }\n.logoimg:hover {\n  cursor: pointer; }\n::ng-deep .mat-form-field-infix {\n  padding: 1.5em 0; }\n.flexhori {\n  display: flex;\n  overflow-x: auto; }\n#navdropdown1 {\n  position: absolute;\n  margin-left: 19%;\n  margin-top: 15px;\n  border: 0px;\n  font-size: 16px;\n  line-height: 2.4;\n  width: 300px;\n  font-family: 'opR','tamilf'; }\n#navdropdown2 {\n  position: absolute;\n  margin-left: 31.5%;\n  margin-top: 15px;\n  border: 0px;\n  font-size: 16px;\n  line-height: 2.4;\n  width: 300px;\n  font-family: 'opR','tamilf'; }\n.submenu {\n  position: absolute;\n  background-color: #fff;\n  right: -21.5rem;\n  margin-top: -4rem;\n  cursor: pointer;\n  padding: 0;\n  display: block; }\n.dropdown-item:hover {\n  color: #CC9F08;\n  cursor: pointer; }\n.downarrowmenu {\n  opacity: 0;\n  margin-left: 0px;\n  transition: 0.5s all ease-in-out;\n  float: right;\n  transform: rotate(-90deg);\n  margin-right: 0rem;\n  margin-top: 1.2rem; }\n.dropdown-item:hover > span > .downarrowmenu {\n  opacity: 1;\n  margin-left: 8px;\n  transition: 0.5s all ease-in-out;\n  float: right;\n  transform: rotate(-90deg);\n  margin-right: 0rem;\n  margin-top: 1.2rem; }\n.flexhori::-webkit-scrollbar {\n  display: none; }\n.flexhorimobile {\n  display: none; }\n.carousel-control-prev {\n  opacity: 0;\n  left: -5%; }\n#prevbut {\n  opacity: 0; }\n.nextCaro {\n  padding: 1em;\n  border-radius: 50%;\n  box-shadow: 0 0 10px 1px #b6b6b6; }\n.left {\n  transform: rotate(90deg); }\n.padl4 {\n  padding-left: 3rem; }\n.right {\n  transform: rotate(-90deg); }\n.navbar-light .navbar-nav .nav-link:hover, .navbar-light .navbar-nav .nav-link:focus {\n  color: #CC9F08; }\n.nav-link:focus .navbar {\n  background-color: #fff; }\n.nav-link:hover {\n  cursor: pointer; }\n#navbarContent {\n  position: relative; }\n#productdropdown {\n  position: absolute;\n  width: 60vw;\n  left: 20vw;\n  border-radius: 5px;\n  top: 9rem;\n  /* margin: auto 0; */\n  background-color: #fff;\n  z-index: 20;\n  display: none;\n  transition: 0.5s all ease-in-out; }\n.width50 {\n  width: 50px; }\n.right {\n  float: right; }\n.mat-select:focus:not(.mat-select-disabled).mat-primary\n.mat-select-arrow, .mat-select-underline, .mat-select-trigger {\n  color: #fff; }\n.carousel-showmanymoveone .carousel-control {\n  width: 4%;\n  background-image: none; }\n.carousel-showmanymoveone .carousel-control.left {\n  margin-left: 0; }\n.carousel-showmanymoveone .carousel-control.right {\n  margin-right: 0; }\n.carousel-showmanymoveone .cloneditem-1,\n.carousel-showmanymoveone .cloneditem-2,\n.carousel-showmanymoveone .cloneditem-3 {\n  display: none; }\n.carousel .item .col-xs-12 {\n  padding: 0; }\n.pad0 {\n  padding: 0; }\n/* Medium Devices, Desktops */\n.img-responsive {\n  height: 540px; }\n.carousel-control {\n  height: 540px; }\n#language {\n  background: transparent;\n  border: 0;\n  color: black; }\n.langclass {\n  width: 6rem;\n  margin: 0 0 0 1rem;\n  background: transparent;\n  color: #fff;\n  margin-top: 1rem;\n  border: 0;\n  outline: 0; }\n.langoption {\n  color: black;\n  background-color: #fff; }\n.langoption:hover {\n  background-color: #fff;\n  color: #CC9F08; }\n#language:focus {\n  outline: 0; }\n#language option {\n  background-color: transparent;\n  border: 5px solid #fff;\n  border-radius: 5em;\n  color: grey; }\n.navbar {\n  display: flex;\n  flex-wrap: wrap;\n  overflow-y: unset;\n  margin: 0;\n  color: #fff;\n  align-items: center;\n  border: 0px;\n  justify-content: left;\n  padding: 0.5rem 1rem 0rem 1rem;\n  position: fixed;\n  z-index: 99;\n  width: 100%;\n  transition: 0.5s all ease-in-out; }\n.navbar ::ng-deep .mat-select-value {\n    color: #fff; }\n.nonmargin {\n  margin-right: 0px; }\n.collectionside {\n  overflow: hidden;\n  /* width: 100%; */\n  border-radius: 5px;\n  position: relative;\n  padding: 0 5px; }\n.collectionsideright {\n  overflow: hidden;\n  /* width: 100%; */\n  border-radius: 5px;\n  position: relative;\n  padding: 0 0px;\n  margin-left: -5px;\n  margin-right: 15px; }\n.p15 {\n  padding-right: 15px; }\n.sidecollectionimage {\n  width: 100%;\n  padding-right: 0px;\n  border-radius: 5px;\n  margin-right: 0;\n  padding: 0; }\n.navbar.scrolled {\n  box-shadow: 0 0 10px 1px #80808029;\n  background: #fff;\n  background-color: #fff;\n  transition: 0.5s all ease-in-out; }\n.navbar.scrolled .phoneicon {\n    filter: brightness(0%) contrast(50%); }\n.navbar.scrolled ::ng-deep .mat-select-value {\n  color: #444; }\n.navbar.scrolled .kidsdiv {\n  padding: 0;\n  margin-left: -5px;\n  margin-right: 15px; }\n.navbar.scrolled ::ng-deep .mat-select-arrow {\n  color: #444;\n  border-left: 15px solid transparent !important;\n  border-right: none !important;\n  border-top: 15px solid transparent !important;\n  border-image-source: none !important;\n  border-image-repeat: stretch !important;\n  margin-top: -2px !important;\n  transform: scale(0.7); }\n.navbar.scrolled .navbar-light .navbar-nav .nav-link .phonelink {\n  color: #000;\n  font: 18px opB, tamilf;\n  padding: 2rem 1rem;\n  text-align: right;\n  transition: 0.5s all ease-in-out; }\n.navbar.scrolled .nav-link:hover, .navbar.scrolled .nav-link:focus {\n  color: #CC9F08; }\n.navbar.scrolled > div > ul > li > a {\n  color: black; }\n.navbar.scrolled > div > span {\n  color: black; }\n.navbar.scrolled > div > ul > li > a:hover {\n  color: #CC9F08;\n  transition: 0.5s all ease-in-out; }\n.navbar-light .navbar-nav .nav-link {\n  color: #fff;\n  font: 18px opB , tamilf;\n  padding: 2rem 0rem 2rem 1rem;\n  text-align: right;\n  transition: 0.5s all ease-in-out; }\n.navbar-brand {\n  margin: 0 !important;\n  padding: 0 0px 0 50px;\n  height: auto;\n  font-size: 18px; }\n.collapser {\n  position: absolute;\n  right: 1em;\n  top: 2.2em; }\n.navbar-light .navbar-toggler {\n  border-width: 0px;\n  outline-width: 0px; }\n.logoimg {\n  height: 75px; }\nul {\n  width: 70%;\n  margin: auto; }\n.navbar-nav > li {\n  padding: 0 30px; }\n.navbar-nav {\n  margin: 0 0% 0 15%;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  overflow-x: auto; }\n.lang {\n  display: flex;\n  flex-direction: row;\n  font-size: 12px;\n  margin-top: 1rem; }\n.langclass {\n  width: 6rem;\n  margin: 2px 0 0 1rem; }\n.phonelink {\n  padding-top: 1.4rem; }\n::ng-deep .mat-form-field-underline {\n  display: none; }\n@media only screen and (max-width: 2600px) {\n  #navdropdown1 {\n    margin-left: 37%; }\n  #navdropdown2 {\n    margin-left: 43.5%; } }\n@media only screen and (max-width: 1600px) {\n  .nav-link {\n    padding: 6px 0rem 1rem; }\n  .navbar-nav {\n    margin: 0 0% 0 9%; }\n  .navbar-nav {\n    margin-left: 15%; }\n  #navdropdown1 {\n    margin-left: 18%; }\n  #navdropdown2 {\n    margin-left: 30%; }\n  .lang {\n    margin-top: 4px; } }\n@media only screen and (max-width: 1300px) {\n  #navdropdown1 {\n    margin-left: 15%; }\n  #navdropdown2 {\n    margin-left: 28%; }\n  .cartext {\n    position: absolute;\n    top: 44vh;\n    left: -40rem;\n    font-family: dance;\n    text-align: center;\n    font-size: 3rem; }\n  .navbar-nav {\n    margin: -5px 0% 0 9%; }\n  .navbar-nav > li {\n    padding: 0px 7px; }\n  .navbar-light .navbar-nav .nav-link {\n    color: #fff;\n    font: 14px opB , tamilf;\n    padding: 2rem 5px; }\n  .lang {\n    float: right;\n    padding: 0 0 0 0;\n    margin-top: -4px; }\n  .carousel .item .col-xs-12:nth-last-child(-n+2) {\n    display: none; }\n  .promiseBody {\n    font-size: 14px; }\n  .PromiseContainer {\n    padding: 3em; } }\n@media screen and (max-width: 1030px) {\n  .navbar-nav {\n    margin: 0 0% 0 13%; }\n  .navbar-nav > li {\n    padding: 0 1%; }\n  .navbar-light .navbar-nav .nav-link {\n    padding: 2rem 1rem;\n    font-size: 14px; }\n  .lang {\n    float: right;\n    padding: 6px 0 0 0; }\n  #navdropdown1 {\n    margin-left: 15%; }\n  #navdropdown2 {\n    margin-left: 28%; } }\n@media screen and (max-width: 912px) {\n  .logoimg {\n    height: 60px; }\n  .navbar-nav > li {\n    padding: 0 0rem; }\n  .navbar-nav {\n    margin: 4px 0% 0 11%; }\n  .navbar {\n    padding: 0.5rem 1rem 1rem 1rem;\n    background: #fff;\n    color: #000; }\n    .navbar ::ng-deep .mat-select-value {\n      color: #444; }\n    .navbar ::ng-deep .mat-select-arrow {\n      color: #444;\n      border-left: 15px solid transparent !important;\n      border-right: none !important;\n      border-top: 15px solid transparent !important;\n      border-image-source: none !important;\n      border-image-repeat: stretch !important;\n      margin-top: -2px !important;\n      transform: scale(0.7); }\n  .navbar.scrolled ::ng-deep .mat-select-value {\n    color: #444; }\n  .navbar > div > ul > li > a {\n    padding: 2rem 1rem 1rem 1rem;\n    background: #fff;\n    color: #000;\n    font-size: 14px; }\n  .navbar-brand {\n    padding-left: 20px; }\n  .phonelink {\n    display: none; }\n  .lang {\n    position: absolute;\n    right: 1rem;\n    top: 1.3rem; }\n  .navbar-light .navbar-nav .nav-link {\n    padding: 2rem 0rem; }\n  .bottom-left {\n    left: 1em; }\n  .collectionwedding {\n    height: 100%; }\n  .left2 {\n    left: 2em; }\n  .padingt20 {\n    padding-top: 20; }\n  #prevbut {\n    opacity: 0; }\n  .imageContainer {\n    padding: 0 15px 0 0; }\n  .carousel-control-next {\n    right: -3% !important; }\n  .homebody > .talktous {\n    font-size: 12px; }\n  .carosolimg {\n    -o-object-position: 75% 90%;\n       object-position: 75% 90%; }\n  .collectionGoldImage {\n    height: 300px;\n    width: auto; }\n  .collectionImage {\n    border-radius: 5px;\n    height: 140px; }\n  .lefter {\n    bottom: 2em;\n    left: 2em; }\n  .padtop10 {\n    padding-top: 10px; }\n  .padl5 {\n    padding-left: 5px; }\n  .padr5 {\n    padding-right: 5px; }\n  .bot1 {\n    bottom: 1em; }\n  .cartext {\n    left: -29rem; }\n  .padding0 {\n    padding: 0; }\n  .marb20 {\n    height: 100%; }\n  #products {\n    margin-left: 0px;\n    margin-top: 5em; }\n  .PromiseContainer {\n    margin-bottom: 4em; }\n  .bodyView {\n    padding: 2em 2em;\n    width: 100%; }\n  .weddingcoll {\n    padding: 0 1em; }\n  .circle {\n    right: 1em; }\n  .mar-3 {\n    margin-bottom: 0em; }\n  .h240 {\n    height: 140px; }\n  .padt20 {\n    padding-top: 20px; }\n  .mar-r-1 {\n    margin-right: 0; } }\n@media screen and (max-width: 700px) {\n  .cartext {\n    left: -25rem; }\n  .bottom-left {\n    left: 2em; }\n  .h240 {\n    height: 140px; }\n  .left2 {\n    left: 2em; }\n  .padingt20 {\n    padding-top: 20; }\n  .padl4 {\n    padding-left: 0rem; }\n  .collectionGoldImage {\n    height: 400px;\n    width: auto; }\n  .marb20 {\n    margin-bottom: 20px; }\n  .collectionwedding {\n    height: 140px; } }\n@media all and (min-width: 768px) {\n  .carousel-showmanymoveone .carousel-inner > .active.left,\n  .carousel-showmanymoveone .carousel-inner > .prev {\n    left: -50%; }\n  .carousel-showmanymoveone .carousel-inner > .active.right,\n  .carousel-showmanymoveone .carousel-inner > .next {\n    left: 50%; }\n  .carousel-showmanymoveone .carousel-inner > .left,\n  .carousel-showmanymoveone .carousel-inner > .prev.right,\n  .carousel-showmanymoveone .carousel-inner > .active {\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner .cloneditem-1 {\n    display: block; } }\n@media all and (min-width: 768px) and (transform-3d), all and (min-width: 768px) and (-webkit-transform-3d) {\n  .carousel-showmanymoveone .carousel-inner > .item.active.right,\n  .carousel-showmanymoveone .carousel-inner > .item.next {\n    transform: translate3d(50%, 0, 0);\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner > .item.active.left,\n  .carousel-showmanymoveone .carousel-inner > .item.prev {\n    transform: translate3d(-50%, 0, 0);\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner > .item.left,\n  .carousel-showmanymoveone .carousel-inner > .item.prev.right,\n  .carousel-showmanymoveone .carousel-inner > .item.active {\n    transform: translate3d(0, 0, 0);\n    left: 0; } }\n@media all and (min-width: 992px) {\n  .carousel-showmanymoveone .carousel-inner > .active.left,\n  .carousel-showmanymoveone .carousel-inner > .prev {\n    left: -16.6%; }\n  .carousel-showmanymoveone .carousel-inner > .active.right,\n  .carousel-showmanymoveone .carousel-inner > .next {\n    left: 16.6%; }\n  .carousel-showmanymoveone .carousel-inner > .left,\n  .carousel-showmanymoveone .carousel-inner > .prev.right,\n  .carousel-showmanymoveone .carousel-inner > .active {\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner .cloneditem-2,\n  .carousel-showmanymoveone .carousel-inner .cloneditem-3 {\n    display: block; } }\n@media all and (min-width: 992px) and (transform-3d), all and (min-width: 992px) and (-webkit-transform-3d) {\n  .carousel-showmanymoveone .carousel-inner > .item.active.right,\n  .carousel-showmanymoveone .carousel-inner > .item.next {\n    transform: translate3d(16.6%, 0, 0);\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner > .item.active.left,\n  .carousel-showmanymoveone .carousel-inner > .item.prev {\n    transform: translate3d(-16.6%, 0, 0);\n    left: 0; }\n  .carousel-showmanymoveone .carousel-inner > .item.left,\n  .carousel-showmanymoveone .carousel-inner > .item.prev.right,\n  .carousel-showmanymoveone .carousel-inner > .item.active {\n    transform: translate3d(0, 0, 0);\n    left: 0; } }\n.carousel-item {\n  transition: 1s all ease-in-out !important; }\n#demo1 {\n  margin-left: -4rem; }\n.nextCaro[_ngcontent-vqv-c6] {\n  padding: 1em;\n  background-color: #fff;\n  border-radius: 50%;\n  margin-top: -10rem; }\n@media screen and (max-width: 500px) {\n  #user2 {\n    display: none; }\n  .disabledclass {\n    background-color: grey; }\n  #prevuser {\n    background-color: grey;\n    padding: 2px;\n    height: 30px;\n    width: 30px;\n    border-radius: 6px;\n    opacity: 1;\n    transition: 0.5s ease all; }\n  #nextuser {\n    opacity: 1;\n    background-color: #CC9F08;\n    padding: 2px;\n    height: 30px;\n    width: 30px;\n    border-radius: 6px;\n    margin-left: 1rem;\n    transition: 0.5s ease all; }\n  .homebody {\n    margin-top: 6rem; }\n  .navbar > div > ul > li > a {\n    font-size: 18px;\n    text-align: left; }\n  #navdropdown1 {\n    margin-bottom: 1rem;\n    box-shadow: none;\n    margin-left: 0;\n    width: 100%;\n    position: unset;\n    background-color: #fff;\n    border: 0px;\n    font-size: 16px;\n    line-height: 2.4;\n    -ms-overflow-style: none;\n    /* IE and Edge */\n    scrollbar-width: none; }\n  #navdropdown2 {\n    margin-bottom: 1rem;\n    box-shadow: none;\n    margin-left: 0;\n    width: 100%;\n    position: unset;\n    background-color: #fff;\n    border: 0px;\n    font-size: 16px;\n    line-height: 2.4;\n    -ms-overflow-style: none;\n    /* IE and Edge */\n    scrollbar-width: none; }\n  .heroc {\n    height: 80vh; }\n  .carosolimg {\n    transition: 0.3s all ease-in-out;\n    height: 100%; }\n  .bodyHeading {\n    margin: 40px 0 32px 0; }\n  .lang {\n    right: 5rem;\n    top: 1.4rem; }\n  .navbar-nav {\n    margin-left: 1rem !important; }\n  .collectionGoldImage {\n    height: 350px; }\n  .padr3 {\n    left: 5em; }\n  .bottom-left {\n    left: 1em; }\n  .top2 {\n    bottom: 2em; }\n  #marriageimg {\n    -o-object-position: 65% 90%;\n       object-position: 65% 90%; }\n  #menimage {\n    -o-object-position: 65% 83%;\n       object-position: 65% 83%; }\n  #womenimg {\n    -o-object-position: 65% 80%;\n       object-position: 65% 80%; }\n  .downarrowmenu {\n    transform: rotate(0deg);\n    opacity: 1; }\n  .dropdown-item:hover > span > .downarrowmenu {\n    transform: rotate(0deg); }\n  .nav-link {\n    font-family: 'opEB','tamilf';\n    color: #CC9F08; }\n  .dropdown-menu > a {\n    font-family: 'opR','tamilf';\n    color: #CC9F08; }\n  .submenu {\n    transition: 0.5s all ease-in-out;\n    position: unset;\n    cursor: pointer;\n    padding: 0;\n    width: 100%;\n    font-weight: 100;\n    margin-top: 0rem;\n    padding: 0 2rem;\n    background-color: #ffffff;\n    border: 1px solid #fff; }\n  .submenu > a {\n    font-family: 'opR','tamilf'; }\n  .collectionsideright {\n    margin-left: 0px;\n    margin-right: 0px; }\n  .padl5 {\n    padding-left: 20px; } }\n#collectiondropdown {\n  display: none; }\n.navbar-nav > .dropdown1:hover + #productdropdown, .navbar-nav > .dropdown1 > #navlink1:hover {\n  display: block !important;\n  transition: 0.5s all ease-in-out; }\n.collectionhover #collectiondropdown {\n  display: block; }\n.dropdown-submenu {\n  position: relative; }\n.dropdown-submenu .dropdown-menu {\n  top: 0;\n  left: 100%;\n  margin-top: -1px;\n  display: block;\n  width: 100%;\n  margin: 10px 0;\n  color: #fff;\n  background-color: #efefef;\n  font-size: 14px;\n  border: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngAfterViewInit = function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_3__(window).scroll(function () {
            ...
            if (jquery__WEBPACK_IMPORTED_MODULE_3__(this).scrollTop() > 50) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_3__('#changedrop').attr("src", "../../../assets/images/languageiconb.svg");
            }
            else {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_3__('#changedrop').attr("src", "../../../assets/images/languageiconw.svg");
                if (window.innerWidth < 900) {
                    jquery__WEBPACK_IMPORTED_MODULE_3__('#changedrop').attr("src", "../../../assets/images/languageiconb.svg");
                }
            }
    ...
    HomeComponent.prototype.toggleuser = function (num) {
        if (num == 1) {
...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.clearcolor = function () {
        document.getElementById("navlink1").style.color = "#000";
        document.getElementById("navlink2").style.color = "#000";
        document.getElementById("navlink3").style.color = "#000";
        document.getElementById("navlink4").style.color = "#000";
    ...
    ProductsComponent.prototype.refreshpage = function () {
        console.log('refresh');
...
module.exports = ".talktous {\n  background-color: #F6F7F7;\n  color: #666666;\n  height: 120px;\n  margin: auto;\n  font-family: 'opR','tamilf';\n  padding: 2em 4.2rem;\n  font-size: 20px; }\n\n.talktousButton {\n  background-color: #CC9F08;\n  color: #fff;\n  border-radius: 5px;\n  font-weight: 600;\n  margin: 1em;\n  float: right;\n  border: 0;\n  padding: 4px 16px;\n  font-family: 'opR','tamilf'; }\n\n.talktouspara {\n  margin: 0;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  text-align: justify;\n  padding-right: 30px;\n  font-family: 'opR','tamilf'; }\n\n.talktousButton {\n  margin: 0;\n  position: absolute;\n  top: 50%;\n  right: 20px;\n  font-family: 'opR','tamilf';\n  transform: translateY(-50%); }\n\n@media screen and (max-width: 800px) {\n  .talktous {\n    font-size: 14px; } }\n\n@media screen and (max-width: 500px) {\n  .talktous {\n    font-size: 12px;\n    padding: 2em 0rem; }\n  .talktouspara {\n    text-align: left; }\n  .talktousButton {\n    right: 5px;\n    padding: 7px; } }\n\n.headerfixed {\n  position: fixed;\n  z-index: 99;\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"todaysrate\" *ngIf=\"desktop\">\r\n    \r\n  <div  class=\"circle\" >\r\n   \r\n  \r\n        <span id=\"today\">\r\n          {{ts.translate('todaysrate')}}\r\n        </span>\r\n        <div  id=\"close\" >X</div>\r\n      \r\n   \r\n      \r\n  </div>\r\n  <div class=\"goldrate\"  id=\"rate\">\r\n    <div class=\"goldratehead\">\r\n        {{ts.translate('todaysrate')}}\r\n    </div>\r\n    <div class=\"goldbody\">\r\n     <div> <span class=\"bold\"><img style=\"width:1.5em;    margin-right: 4px;\" src=\"../../../assets/images/goldrate.png\" /> {{ts.translate('Gold') |  titlecase }} 1gm</span> - RS {{goldprice}}</div>\r\n     <div> <span class=\"bold\"><img  style=\"width:1.5em;    margin-right: 4px;\" src=\"../../../assets/images/silverrate.png\" /> {{ts.translate('Silver') |  titlecase }}  1gm</span> - RS {{silverprice}}</div>\r\n    </div>\r\n  </div>\r\n  <div class=\"bar\"></div>\r\n  \r\n\r\n</div>\r\n\r\n<div class=\"todaysrate1\" *ngIf=\"!desktop\">\r\n    \r\n  <div  class=\"circle1\" (click)=\"toggle()\">\r\n   \r\n  \r\n        <span id=\"today1\">\r\n          {{ts.translate('todaysrate')}}\r\n        </span>\r\n        <div  id=\"close1\" >X</div>\r\n      \r\n   \r\n      \r\n  </div>\r\n  <div class=\"goldrate1\"  id=\"rate1\">\r\n    <div class=\"goldratehead1\">\r\n        {{ts.translate('todaysrate')}}\r\n    </div>\r\n    <div class=\"goldbody1\">\r\n     <div> <span class=\"bold1\"><img style=\"width:1.5em;    margin-right: 4px;\" src=\"../../../assets/images/goldrate.png\" /> {{ts.translate('Gold') |  titlecase }} 1gm</span> - RS {{goldprice}}</div>\r\n     <div> <span class=\"bold1\"><img  style=\"width:1.5em;    margin-right: 4px;\" src=\"../../../assets/images/silverrate.png\" /> {{ts.translate('Silver') |  titlecase }}  1gm</span> - RS {{silverprice}}</div>\r\n    </div>\r\n  </div>\r\n  <div class=\"bar1\"></div>\r\n  \r\n\r\n</div>"
...
module.exports = ".todaysrate {\n  position: fixed;\n  display: inline-flex;\n  top: 77%;\n  right: 0;\n  text-align: right;\n  z-index: 5;\n  font-family: 'opR','tamilf';\n  cursor: pointer; }\n\n.bar {\n  height: 3px;\n  width: 3em;\n  margin-top: 34px;\n  background-color: #A57F00; }\n\n.circle {\n  height: 70px;\n  width: 70px;\n  padding-top: 17px;\n  font-size: 12px;\n  display: flex;\n  flex: 1;\n  margin: auto 0;\n  padding-left: -10px;\n  text-align: center;\n  overflow-wrap: break-word;\n  white-space: break-spaces;\n  border-radius: 50%;\n  background-color: #A57F00;\n  color: #fff; }\n\n.circle p.new-label span {\n  font-size: 12px;\n  line-height: 1.5rem;\n  font-weight: 100;\n  white-space: pre-wrap;\n  position: relative; }\n\n.success {\n  width: 100%; }\n\n.circle:hover p.new-label span {\n  display: none; }\n\n.circle:hover p.new-label:after {\n  font-size: 12px;\n  line-height: 1.5rem;\n  font-weight: 100;\n  white-space: pre-wrap;\n  text-align: center;\n  width: 100%;\n  margin-top: 8px; }\n\n.circle:hover {\n  padding-top: 23px; }\n\n#today {\n  opacity: 1; }\n\n#close {\n  display: none;\n  position: absolute;\n  left: 28px;\n  top: 19px;\n  font-size: 23px;\n  font-family: 'avenirR';\n  font-weight: 900; }\n\n.circle:hover > #today, .circle:active > #today {\n  opacity: 0; }\n\n.circle:hover > #close, .circle:active > #close {\n  display: block; }\n\n.circle:hover + .goldrate, .circle:active + .goldrate {\n  display: block;\n  transform: scale(1);\n  color: black; }\n\n.circle:focus > #close {\n  display: block; }\n\n.circle:focus > #today {\n  opacity: 0; }\n\n.circle:focus + .goldrate {\n  display: block;\n  transform: scale(1);\n  color: black; }\n\n.goldrate {\n  width: 15em;\n  font-size: 12px;\n  position: absolute;\n  top: -14rem;\n  right: 3em;\n  text-align: center;\n  background-color: #fff;\n  border-radius: 5px;\n  display: none;\n  transform: scale(1.2);\n  transition: 0.3s all ease-in-out; }\n\n.goldratehead {\n  background-color: #A57F00;\n  color: #fff;\n  border-top-left-radius: 5px;\n  border-top-right-radius: 5px;\n  padding: 8px; }\n\n.bold {\n  font-weight: 600; }\n\n.goldbody {\n  padding: 8px;\n  border-left: 2px solid #ececec;\n  border-bottom: 2px solid #ececec;\n  border-right: 2px solid #ececec;\n  border-radius: 5px;\n  line-height: 3rem; }\n\n.todaysrate1 {\n  position: fixed;\n  display: inline-flex;\n  top: 77%;\n  right: 0;\n  text-align: right;\n  z-index: 5;\n  font-family: 'opR','tamilf';\n  cursor: pointer; }\n\n.bar1 {\n  height: 3px;\n  width: 3em;\n  margin-top: 34px;\n  background-color: #A57F00; }\n\n.circle1 {\n  height: 70px;\n  width: 70px;\n  padding-top: 17px;\n  font-size: 12px;\n  display: flex;\n  flex: 1;\n  margin: auto 0;\n  padding-left: -10px;\n  text-align: center;\n  overflow-wrap: break-word;\n  white-space: break-spaces;\n  border-radius: 50%;\n  background-color: #A57F00;\n  color: #fff; }\n\n.circle1 p.new-label1 span {\n  font-size: 12px;\n  line-height: 1.5rem;\n  font-weight: 100;\n  white-space: pre-wrap;\n  position: relative; }\n\n.success1 {\n  width: 100%; }\n\n#today1 {\n  opacity: 1; }\n\n#close1 {\n  display: none;\n  position: absolute;\n  left: 28px;\n  top: 19px;\n  font-size: 23px;\n  font-family: 'avenirR';\n  font-weight: 900; }\n\n.goldrate1 {\n  width: 15em;\n  font-size: 12px;\n  position: absolute;\n  top: -14rem;\n  right: 3em;\n  text-align: center;\n  background-color: #fff;\n  border-radius: 5px;\n  display: none;\n  transform: scale(1.2);\n  transition: 0.3s all ease-in-out; }\n\n.goldratehead1 {\n  background-color: #A57F00;\n  color: #fff;\n  border-top-left-radius: 5px;\n  border-top-right-radius: 5px;\n  padding: 8px; }\n\n.bold1 {\n  font-weight: 600; }\n\n.goldbody1 {\n  padding: 8px;\n  border-left: 2px solid #ececec;\n  border-bottom: 2px solid #ececec;\n  border-right: 2px solid #ececec;\n  border-radius: 5px;\n  line-height: 3rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TodaysrateComponent = /** @class */ (function () {
    ...
    TodaysrateComponent.prototype.toggle = function () {
        if (this.flag == true) {
...
var TopsellingComponent = /** @class */ (function () {
    ...
    TopsellingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_translate_translate_service__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], src_app_services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialog"]])
    ], TopsellingComponent);
